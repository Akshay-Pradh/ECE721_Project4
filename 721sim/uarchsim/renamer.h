...
public:
	free_list(uint64_t size);	// constructor

	void write_entry(uint64_t index, uint64_t value);
	uint64_t read_entry(uint64_t index);

	bool is_empty();
	bool is_full();
	bool has_space(uint64_t n_registers);

	uint64_t get_free();
	uint64_t retire_free();
	void push_free(uint64_t phys_reg);
	...
	void set_head(uint64_t new_head);
	void set_head_phase(bool new_phase);
	void reset();
};
...
typedef struct branch_checkpoint {
	std::vector<uint64_t> shadow_RMT;
	uint64_t head;
	bool head_phase;
	uint64_t GBM;
}branch_checkpoint;
...
class active_list {
private:
	std::vector<active_list_entry> entries;
	uint64_t head;
	uint64_t tail;
	bool head_phase;
	bool tail_phase;
public:
	active_list(uint64_t size);					// Constructor
	uint64_t active_list_size;

	bool has_space(uint64_t n_registers);
	bool is_empty();

	uint64_t push_instruction(active_list_entry entry);
	...
	active_list_entry get_head_instr();
	uint64_t get_head();
	bool get_head_phase();
	uint64_t get_tail();
	bool get_tail_phase();
	...
	void advance_head();
	void restore_tail(uint64_t index);
	void restore_tail_phase(bool phase);
...
private:
	...
	/////////////////////////////////////////////////////////////////////
	std::vector<uint64_t> RMT;		// size = # logical registers
	/////////////////////////////////////////////////////////////////////
	// Structure 2: Architectural Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
	std::vector<uint64_t> AMT;		// size = # logical registers
	/////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////
	free_list FreeList;				// size = # physical registers - # logical registers
	/////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////
	std::vector<bool> PRF_ready_array;
	/////////////////////////////////////////////////////////////////////
	...
	// 3. checkpointed GBM
	/////////////////////////////////////////////////////////////////////
	std::vector<branch_checkpoint> checkpoints;
	/////////////////////////////////////////////////////////////////////
	// Private functions.
...
public:
	...
	//   a free bit exists: it is the   responsibility to avoid
